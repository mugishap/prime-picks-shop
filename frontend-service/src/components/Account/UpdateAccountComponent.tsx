...
const UpdateAccountComponent: React.FC<{}> = ({ }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        try {
            ...
            useUpdateUser({ setUpdateUser,setUserData, userData, setLoading, dispatch })
        } catch (error) {
            console.log(error);
        }
    };
                    ...
                    <form className="flex w-full flex-col" onSubmit={handleSubmit}>
                        ...
                        <div className="my-1">
                            ...
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                                    setUserData({ ...userData, mobile: e.target.valueAsNumber });
                                }}
                        ...
                        <div className="mt-8">
                            <button
                                ...
                                disabled={loading}
                            >
                                {loading ? <BiLoaderAlt className="animate-spin" size={25} /> : "UPDATE"}
                            </button>
                        </div>
                    </form >
                </div>
