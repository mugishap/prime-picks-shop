        ...
        <div className="flex py-20 px-4 md:px-6 xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
          <div className="flex  flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
            <div className="flex justify-start items-center space-x-4">
              <div className="cursor-pointer w-12">
                <img src={Logo} alt="logo" className="bg-slate-400 rounded-full" />
              </div>
            ...
            <div className="mt-12 xl:mt-0 grid grid-cols-1 sm:grid-cols-3 gap-y-12 sm:gap-y-0 w-full md:w-auto sm:gap-x-20 md:gap-x-28 xl:gap-8">
              <div className="sm:w-40 md:w-auto xl:w-72 flex justify-start items-start flex-col space-y-6">
                ...
                {Community.map((community) => {
                  return (
                    <button
                      className="text-left text-base hover:text-gray-400 leading-none text-black"
                      key={community}
                    >
                      {community}
                    </button>
              ...
              <div className=" xl:w-72 flex justify-start items-start flex-col space-y-6">
                ...
                {resources.map((text) => {
                  return (
                    <button
                      className="text-base text-left hover:text-gray-400 leading-none text-black"
                      key={text}
                    >
                      {text}
                    </button>
          ...
          <div className="mt-12 flex  xl:justify-between xl:flex-row flex-col-reverse items-center xl:items-start w-full ">
            <p className="mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-black">
              {(new Date()).getFullYear()} Prime Picks LTD. All Rights Reserved
            </p>
            <div className="mt-10 md:mt-12 xl:mt-0 md:flex-row flex-col flex md:justify-center w-full md:w-auto justify-start items-start space-y-4 md:space-y-0 md:items-center md:space-x-4 xl:space-x-6">
              {links.map((link) => {
                return (
                  <button
                    className="text-base leading-none text-black hover:text-gray-300"
                    key={link}
                  >
                    {link}
                  </button>
            ...
            <div className="flex  justify-start md:justify-end items-start  w-full md:w-auto md:items-center space-x-6 ">
              <a href="https://twitter.com/Pre_mugisha" className="text-black hover:text-gray-600 w-6" target={"_blank"}>
                <Twitter />
              </a>
              <a href="https://web.facebook.com/beni.precieux" className="text-black hover:text-gray-600 w-6" target={"_blank"}>
                <Facebook />
              </a>
              <a className="text-black hover:text-gray-600 w-6" href="http://github.com/mugishap" target={"_blank"}>
                <GitHub />
              </a>
            </div>
          </div>
