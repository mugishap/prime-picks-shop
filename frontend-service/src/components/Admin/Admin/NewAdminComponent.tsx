                    ...
                    <div className="my-1 w-full">
                        ...
                        <div className="relative flex items-center justify-center">
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setAdminData({ ...adminData, password: e.target.value })}
                            ...
                            <div className="absolute right-0 mt-2 mr-3 cursor-pointer">
                                <svg
                                    ...
                                    onClick={() => setAdminData({ ...adminData, showPassword: !adminData.showPassword })}
                                >
                                    <path
