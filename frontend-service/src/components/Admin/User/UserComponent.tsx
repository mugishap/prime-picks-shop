            ...
            <TableBody className=''>
              {(rowsPerPage > 0
                ...
                >
                  ...
                  <TableCell align="right"><button onClick={() => me._id === user._id && <Navigate to={"/account"} />} className='bg-red-500 font-bold px-6 py-2 rounded text-white'>{user._id === me._id ? "Settings" : "Delete"}</button></TableCell>
                </TableRow>
              ))}
            </TableBody>
            <TableFooter>
