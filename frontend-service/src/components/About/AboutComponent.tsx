        ...
        <div className="flex lg:flex-row flex-col justify-around lg:gap-8 sm:gap-10 gap-12">
          <div className="w-full lg:w-6/12">
            <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
              We are here to give you one of the most popular trending
              and best quality tech products
            </h2>
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
              Prime Picks aims to provide a seamless and convenient online shopping experience for tech enthusiasts by offering a curated selection of top-quality tech products, combined with exceptional customer service, fast and reliable shipping, and competitive prices. Our mission is to empower customers to make informed purchasing decisions, stay up-to-date with the latest tech trends, and enjoy the convenience of online shopping for all their tech needs.
            </p>
            <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
              We strive to create a trusted and reliable platform that tech-savvy shoppers can rely on to find the best tech products, discover new gadgets, and have a seamless shopping experience from start to finish. Our ultimate goal is to become the go-to destination for tech enthusiasts, providing an unparalleled shopping experience that exceeds customer expectations and fosters a loyal and satisfied customer base.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
